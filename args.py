...
parser.add_argument('--output_spout', action='store_true')
...
if args.output_webcam is None and args.output_dir is None and args.output_spout is None: args.debug = True
